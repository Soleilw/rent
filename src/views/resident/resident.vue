<template>
  <div v-loading="loading" element-loading-text="拼命加载中">
        ...
        <template slot-scope="scope">
          <el-dropdown>
            ...
            <el-dropdown-menu slot="dropdown">
              ...
              <el-dropdown-item>
                <el-button size="mini" type="primary" @click="openedServe(scope.$index, scope.row)">已开通的服务</el-button>
              </el-dropdown-item>
              <el-dropdown-item>
                <el-button type="primary" size="mini" @click="handleFace(scope.$index, scope.row)">开通人脸</el-button>
              </el-dropdown-item>
              <el-dropdown-item>
                <el-button type="danger" size="mini" @click="handleForbidden(scope.$index, scope.row)">禁用人脸</el-button>
              </el-dropdown-item>
              <el-dropdown-item>
    ...
    <!-- 禁用人脸 -->
    <el-dialog :visible.sync="dialogForbidden" title="禁用人脸" width="20%" align="center" :close-on-click-modal="false">
    ...
    <!-- 开通人脸 -->
    <el-dialog :visible.sync="dialogFace" title="开通人脸" width="20%" align="center" :close-on-click-modal="false">
    ...
    <!-- 开通服务 -->
    <el-dialog title="开通服务" :visible.sync="dialogOpenServe" width="20%" align="center" :close-on-click-modal="false">
      <div style="font-size: 20px; margin-bottom: 30px">
        <el-select v-model="title" placeholder="请选择需要开通的服务" @change="serveChange">
          <el-option v-for="item in serviceLists" :key="item.id" :label="item.title" :value="item.id"></el-option>
        </el-select>
      </div>
        ...
        <el-form :model="userForm" label-width="80px">
          ...
          <el-form-item label="选择身份">
            <el-select v-model="userForm.type" placeholder="请选择身份" @change="roleChange">
              <el-option v-for="item in rolesList" :key="item.type" :label="item.name" :value="item.type"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="选择社区">
            ...
            <el-select v-model="address" placeholder="请选择详细地址" @change="detailAddressChnage" style="margin-right: 10px"
              filterable>
    ...
    <!-- 通过人脸 -->
    <el-dialog :visible.sync="dialogPassFace" title="通过人脸" width="20%" align="center" :close-on-click-modal="false">
    ...
    <!-- 更换人脸 -->
    <el-dialog title="更换人脸" :visible.sync="dialogChangeFace" :close-on-click-modal="false" width="500px">
      <div class="box">
